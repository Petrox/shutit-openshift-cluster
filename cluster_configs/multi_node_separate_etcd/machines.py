...
machines.update({'etcd1':{'fqdn':'etcd1.vagrant.test','is_node':False,'region':'none'}})
machines.update({'etcd2':{'fqdn':'etcd2.vagrant.test','is_node':False,'region':'none'}})
machines.update({'etcd3':{'fqdn':'etcd3.vagrant.test','is_node':False,'region':'none'}})
